...
public class DemoQaComAutoForm extends DemoQaComAutoFormTestBase {
	...
	@Test
	@Description("Успешный Автотест на проверку заполнения формы https://demoqa.com/automation-practice-form")
	@Owner("Калинченко Андрей Дмитриевич")

	//	УСПЕШНО !!!

	public void DemoQaComAutoFormSuccesfullTest() {
...
//sleep(99999999);
	...
	@Test
	@Description("НЕуспешный Автотест на проверку заполнения формы https://demoqa.com/automation-practice-form")
	@Owner("Калинченко Андрей Дмитриевич")
	public void DemoQaComAutoFormUnsuccesfullTest() {
		...
		step("2 Шаг: Заполнить форму - Телефон", () ->
		{
			$x(".//*[@id='userNumber']").setValue("+12345"); //ввёл неверный формат телефона: "+" не может быть и недостаточное кол-во знаков
		});
